...
ALTER PROCEDURE SPLoad.AbsaCustomerDimensionsUpdateFactLoad ( @Monthdate INT = NULL)
AS
...
BEGIN
	SET @Monthdate =  (SELECT DISTINCT CAST (CONVERT(VARCHAR(8),(SELECT MAX(INFORMATIONDATESK) FROM [AbsaCustomerValueManagementMartH].[Report].[CustomerView]),112) AS INT)) 
END
...
FROM	[AbsaCustomerValueManagementMartH].[Report].[CustomerView] A
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			 
	DELETE	FROM AbsaCustomerValueManagementMartH.Report.[CustomerViewFact] 		
	WHERE	INFORMATIONDATESK = @Monthdate



	SELECT TOP 4 * FROM AbsaCustomerValueManagementMartH.Report.[CustomerView_LatestTest]
--/////////////////////////////////////////////////////////////////////////////////////
...
SELECT  CustomerSK, INFORMATIONDATESK, CustomerKey,ISNULL(DateCifOpenedsk,19000101) AS DateCifOpenedsk, CustomerSegmentSk, 
		...
		ProductASk,[Customer count], [Excusion accounts], [SilentAttriningCuslSK], [SACustomer],IncomeGroupCode, IncomeGroupDesc,
		[Non Interest Revenue], [Net Interest Income], TopLineIncome, TierID, StatusID, EarnAmount, Rewards, EarningRangeSk, RewardsBalance
INTO	AbsaCustomerValueManagementMartH.Report.[CustomerViewLatestFact]
...
WHERE A.INFORMATIONDATESK < 20210630

INSERT INTO [Dimension].[RewardsEarningRange]
SELECT DISTINCT EarnMoreThanFee,	EarnLessThanFee,	ZeroEarn
FROM AbsaCustomerValueManagementMartH.Report.[CustomerView_LatestTest]


CREATE TABLE AbsaCustomerValueManagementMartH.[Dimension].[IncomeGroup]
(
    IncomeGroupSK INT IDENTITY(0,1) NOT NULL PRIMARY KEY,
	IncomeGroupCode INT NOT NULL,
	IncomeGroupDesc VARCHAR(30) NOT NULL
)
...
FROM AbsaCustomerValueManagementMartH.Report.[CustomerView_LatestTest]
ORDER BY CAST(IncomeGroupCode AS INT)


SELECT * FROM AbsaCustomerValueManagementMartH.[Dimension].[IncomeGroup]

SELECT * FROM [Dimension].[RewardsEarningRange]

CREATE TABLE AbsaCustomerValueManagementMartH.[Dimension].[RewardsEarningRange]
(
   EarningRangeSk INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
   EarnMoreThanFee VARCHAR(1) NOT NULL,	
   EarnLessThanFee VARCHAR(1) NOT NULL,	
   ZeroEarn VARCHAR(1) NOT NULL
)


SELECT * FROM AbsaCustomerValueManagementMartH.Report.[CustomerViewLatestFact]
...
SELECT * FROM AbsaCustomerValueManagementMartH.[Dimension].[InformationDate]

ALTER TABLE AbsaCustomerValueManagementMartH.[Dimension].[InformationDate]
ALTER COLUMN INFORMATIONDATE DATE NOT NULL
--////////////////////////////////////////////////////////////////////////////////////////////////////////
